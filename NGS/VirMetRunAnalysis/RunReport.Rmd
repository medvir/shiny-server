...
blocklist <-
  read_csv(params$blocklist_file)
...
# if in shiny app selected, remove entries from blocklist provided
...
# Print statements in report if phages or blocklisted viruses were removed
phages_removed_text <- ""
if (isTRUE(params$checkbox_phages)) {
